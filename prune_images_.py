...
if __name__ == "__main__":
    # ===== 여기만 수정해서 사용 =====
    TRAIN_TXT = r"C:\Users\sumin\sumin\KIDP__yolo_dt\train.txt"
    TARGET_FOLDER = r"C:\Users\sumin\sumin\KIDP__yolo_dt\data\images\train"
    DRY_RUN = True       # 먼저 True로 확인 후, 실제 삭제 시 False
    RECURSIVE = True    # 하위 폴더까지 탐색하려면 True
    # ============================
